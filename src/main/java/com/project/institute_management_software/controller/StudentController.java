...
public class StudentController {
    ...
    public ResponseEntity<StudentResponse> addStudent(@RequestBody AddStudentRequest addStudentRequest) {
        ...
        if (student.getCourse() == null) {
            studentResponse.setMessage("Please assign a valid course to the student.");
     ...
     */
    @PutMapping("/update")
    public ResponseEntity<StudentResponse> updateStudent(@RequestParam int id, @RequestBody EditStudentRequest editStudentRequest) {
